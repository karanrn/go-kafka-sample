...
type EmployeeRequest struct {
	...
	Desgination string `protobuf:"bytes,5,opt,name=desgination,proto3" json:"desgination,omitempty"`
}
...
func (x *EmployeeRequest) GetEmpId() int64 {
	if x != nil {
		return x.EmpId
	}
	return 0
...
func (x *EmployeeRequest) GetDob() string {
	if x != nil {
		return x.Dob
	}
	return ""
...
func (x *EmployeeRequest) GetDesgination() string {
	if x != nil {
		return x.Desgination
	}
	return ""
}
...
func (x *EmployeeResponse) GetEmpId() int64 {
	if x != nil {
		return x.EmpId
	}
	return 0
...
var file_employee_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x65, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x0f, 0x45,
	0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14,
	0x0a, 0x05, 0x65, 0x6d, 0x70, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x65,
	0x6d, 0x70, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x66, 0x69, 0x72, 0x73, 0x74, 0x4e, 0x61, 0x6d,
	...
	,
...
var file_employee_proto_depIdxs = []int32{
	0, // 0: employee.Operation.WriteEmployee:input_type -> employee.EmployeeRequest
	1, // 1: employee.Operation.WriteEmployee:output_type -> employee.EmployeeResponse
...
type OperationClient interface {
	WriteEmployee(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error)
}
...
func (c *operationClient) WriteEmployee(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*EmployeeResponse, error) {
	out := new(EmployeeResponse)
	err := c.cc.Invoke(ctx, "/employee.Operation/WriteEmployee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OperationServer interface {
	WriteEmployee(context.Context, *EmployeeRequest) (*EmployeeResponse, error)
}
...
func (*UnimplementedOperationServer) WriteEmployee(context.Context, *EmployeeRequest) (*EmployeeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WriteEmployee not implemented")
}
...
func _Operation_WriteEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EmployeeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OperationServer).WriteEmployee(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/employee.Operation/WriteEmployee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OperationServer).WriteEmployee(ctx, req.(*EmployeeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Operation_serviceDesc = grpc.ServiceDesc{
	ServiceName: "employee.Operation",
	HandlerType: (*OperationServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "WriteEmployee",
			Handler:    _Operation_WriteEmployee_Handler,
		},
	},
